...
<device_state libver="3.4" filemajor="1" fileminor="0">
    <device name="EY16M" base_name="EY16M" unique_name="EY16M 44814045">
        <videoformat>Y800 (1440x1080)</videoformat>
        <fps>236.00490890210517136</fps>
        <fliph>0</fliph>
        <flipv>0</flipv>
        <vcdpropertyitems>
            ...
            <item guid="{284C0E0B-010B-45BF-8291-09D90A459B28}" name="Gamma">
                <element guid="{B57D3000-0AC6-4819-A609-272A33140ACA}" name="Value">
                    <itf guid="{99B44940-BFE1-4083-ADA1-BE703F4B8E08}" value="1." />
                </element>
            </item>
            ...
            <item guid="{90D5702E-E43B-4366-AAEB-7A7A10B448B4}" name="Exposure">
                ...
                <element guid="{B57D3000-0AC6-4819-A609-272A33140ACA}" name="Value">
                    <itf guid="{99B44940-BFE1-4083-ADA1-BE703F4B8E08}" value="7.4590002186596393585205078125e-03" />
                </element>
                ...
                <element guid="{6519038F-1AD8-4E91-9021-66D64090CC85}" name="Auto Max Value">
                    <itf guid="{99B44940-BFE1-4083-ADA1-BE703F4B8E08}" value="3.33329997956752777099609375e-02" />
                </element>
            ...
            <item guid="{E33B9C58-0BF8-442D-8035-B4ABD7AF44AA}" name="Flip Horizontal">
                <element guid="{B57D3000-0AC6-4819-A609-272A33140ACA}" name="Enable">
                    <itf guid="{99B44940-BFE1-4083-ADA1-BE703F4B8E04}" value="0" />
                </element>
            </item>
            <item guid="{E33B9C58-0BF8-442D-8035-B4ABD7AF44AB}" name="Flip Vertical">
                <element guid="{B57D3000-0AC6-4819-A609-272A33140ACA}" name="Enable">
                    <itf guid="{99B44940-BFE1-4083-ADA1-BE703F4B8E04}" value="0" />
                </element>
            </item>
            ...
            <item guid="{2CED6FD6-AB4D-4C74-904C-D682E53B9CC5}" name="Partial scan">
                <element guid="{87FB6C02-98A8-46B0-B18D-6442D9775CD3}" name="Y Offset">
                    <itf guid="{99B44940-BFE1-4083-ADA1-BE703F4B8E03}" value="452" />
                </element>
                <element guid="{5E59F654-7B47-4458-B4C6-5D4F0D175FC1}" name="X Offset">
                    <itf guid="{99B44940-BFE1-4083-ADA1-BE703F4B8E03}" value="352" />
                </element>
            ...
            <item guid="{124922E5-81C7-4587-867D-7BA16AF79079}" name="Auto Functions ROI">
                <element guid="{B57D3000-0AC6-4819-A609-272A33140ACA}" name="Enabled">
                    <itf guid="{99B44940-BFE1-4083-ADA1-BE703F4B8E04}" value="0" />
                </element>
                <element guid="{93D840ED-B7B8-45FE-91E2-18E68C41AFC3}" name="Preset">
